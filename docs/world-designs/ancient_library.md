...
- **Central court and garden:** the fountain `(17,13)` anchors the paved central court; an
  irregular scrub blob south of it is the only green ground in the zone.
