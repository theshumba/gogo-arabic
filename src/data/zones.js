...
const oasis_village = {
  ...
  objects: [
    ...
    { key: 'kenmi-desert-props-palm-tree-1', x: 28, y: 4, collide: true, collideW: 30, collideH: 20 },
    ...
    { key: 'kenmi-desert-temple-desert-obelisk-small-1', x: 11, y: 3, collide: true, collideW: 20, collideH: 20 },
    { key: 'kenmi-desert-houses-desert-house-2.1', x: 10, y: 14, collide: true, collideW: 180, collideH: 80 },
    ...
    { key: 'kenmi-desert-houses-desert-house-4.1', x: 34, y: 10, collide: true, collideW: 240, collideH: 100 },
    { key: 'kenmi-desert-houses-desert-house-1.1', x: 2, y: 3, collide: true, collideW: 180, collideH: 80 },
  ],
...
const ancient_library = {
  ...
  objects: [
    ...
    { key: 'kenmi-desert-houses-desert-house-3.1', x: 14, y: 5, collide: true, collideW: 240, collideH: 100 },
    { key: 'kenmi-desert-houses-desert-house-4.1', x: 20, y: 5, collide: true, collideW: 240, collideH: 100 },
    { key: 'kenmi-desert-houses-desert-house-1.1', x: 8, y: 10, collide: true, collideW: 180, collideH: 80 },
    { key: 'kenmi-desert-houses-desert-house-2.1', x: 26, y: 10, collide: true, collideW: 180, collideH: 80 },
...
const desert_marketplace = {
  ...
  objects: [
    ...
    { key: 'kenmi-desert-houses-desert-house-1.1', x: 10, y: 12, collide: true, collideW: 180, collideH: 80 },
    { key: 'kenmi-desert-houses-desert-house-2.1', x: 10, y: 22, collide: true, collideW: 180, collideH: 80 },
    { key: 'kenmi-desert-houses-desert-house-1.1', x: 30, y: 12, collide: true, collideW: 180, collideH: 80 },
    { key: 'kenmi-desert-houses-desert-house-2.1', x: 30, y: 22, collide: true, collideW: 180, collideH: 80 },
    { key: 'kenmi-desert-houses-desert-house-3.1', x: 22, y: 4, collide: true, collideW: 240, collideH: 100 },
    { key: 'kenmi-desert-houses-desert-house-4.1', x: 22, y: 28, collide: true, collideW: 240, collideH: 100 },
...
const farmland = {
  ...
  objects: [
    // Farm buildings
    { key: 'kenmi-desert-houses-desert-house-3.1', x: 10, y: 3, collide: true, collideW: 240, collideH: 100 },
    { key: 'kenmi-desert-houses-desert-house-1.1', x: 35, y: 3, collide: true, collideW: 180, collideH: 80 },
    { key: 'kenmi-desert-houses-desert-house-2.1', x: 8, y: 22, collide: true, collideW: 180, collideH: 80 },
    // Trees around fields
...
const bedouin_camp = {
  ...
  objects: [
    // Tent structures
    { key: 'kenmi-desert-houses-desert-house-1.1', x: 7, y: 6, collide: true, collideW: 180, collideH: 80 },
    { key: 'kenmi-desert-houses-desert-house-2.1', x: 27, y: 6, collide: true, collideW: 180, collideH: 80 },
    { key: 'kenmi-desert-houses-desert-house-1.1', x: 7, y: 17, collide: true, collideW: 180, collideH: 80 },
...
const mountain_village = {
  ...
  objects: [
    // Village buildings
    { key: 'kenmi-desert-houses-desert-house-3.1', x: 15, y: 9, collide: true, collideW: 240, collideH: 100 },
    { key: 'kenmi-desert-houses-desert-house-4.1', x: 25, y: 9, collide: true, collideW: 240, collideH: 100 },
    { key: 'kenmi-desert-houses-desert-house-1.1', x: 14, y: 18, collide: true, collideW: 180, collideH: 80 },
    { key: 'kenmi-desert-houses-desert-house-2.1', x: 26, y: 18, collide: true, collideW: 180, collideH: 80 },
...
const coastal_port = {
  ...
  objects: [
    // Port buildings
    { key: 'kenmi-desert-houses-desert-house-3.1', x: 15, y: 10, collide: true, collideW: 240, collideH: 100 },
    { key: 'kenmi-desert-houses-desert-house-4.1', x: 22, y: 10, collide: true, collideW: 240, collideH: 100 },
    { key: 'kenmi-desert-houses-desert-house-1.1', x: 10, y: 22, collide: true, collideW: 180, collideH: 80 },
    { key: 'kenmi-desert-houses-desert-house-2.1', x: 22, y: 22, collide: true, collideW: 180, collideH: 80 },
    // Dock structures
...
const royal_palace = {
  ...
  objects: [
    // Palace structures
    { key: 'kenmi-desert-houses-desert-house-3.1', x: 20, y: 8, collide: true, collideW: 240, collideH: 100 },
    { key: 'kenmi-desert-houses-desert-house-4.1', x: 30, y: 8, collide: true, collideW: 240, collideH: 100 },
    { key: 'kenmi-desert-houses-desert-house-3.1', x: 15, y: 15, collide: true, collideW: 240, collideH: 100 },
    { key: 'kenmi-desert-houses-desert-house-4.1', x: 35, y: 15, collide: true, collideW: 240, collideH: 100 },
