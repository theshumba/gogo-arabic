...
const FARM_OBJECTS = [
  ...
  { key: 'kenmi-base-crops-grapes-bower', x: 38, y: 29, collide: false },
  { key: 'kenmi-base-crops-berries', x: 31, y: 22, collide: false, cropIndex: 2 },
...
const bedouin_camp = {
  ...
  objects: [
    ...
    { key: 'kenmi-military-military-tents', x: 24, y: 16, cropIndex: 4, collide: true, collideW: 150, collideH: 50 },
    { key: 'kenmi-base-buildings-buildings-tent-tent-big', x: 17, y: 5, collide: true, collideW: 170, collideH: 48 },
    { key: 'kenmi-base-buildings-buildings-tent-tent-small', x: 13, y: 6, collide: true, collideW: 110, collideH: 36 },
    { key: 'kenmi-base-buildings-buildings-tent-tent-small', x: 20, y: 6, collide: true, collideW: 110, collideH: 36 },
    { key: 'kenmi-base-buildings-buildings-tent-tent-small', x: 14, y: 8, collide: true, collideW: 110, collideH: 36 },
    { key: 'kenmi-base-buildings-buildings-tent-tent-small', x: 23, y: 6, collide: true, collideW: 110, collideH: 36 },
    { key: 'kenmi-base-buildings-buildings-tent-tent-small', x: 30, y: 6, collide: true, collideW: 110, collideH: 36 },
    { key: 'kenmi-base-buildings-buildings-tent-tent-small', x: 4, y: 17, collide: true, collideW: 110, collideH: 36 },
    { key: 'kenmi-base-buildings-buildings-tent-tent-small', x: 10, y: 17, collide: true, collideW: 110, collideH: 36 },
    { key: 'kenmi-base-buildings-buildings-tent-tent-small', x: 13, y: 16, collide: true, collideW: 110, collideH: 36 },
    { key: 'kenmi-base-buildings-buildings-tent-tent-small', x: 21, y: 16, collide: true, collideW: 110, collideH: 36 },
    { key: 'kenmi-military-banners-anim', x: 4, y: 6, collide: false },
    ...
    { key: 'kenmi-desert-animals-camel-camel-1', x: 30, y: 21, cropIndex: 1, collide: true, collideW: 28, collideH: 18 },
    ...
    { key: 'kenmi-desert-props-sleeping-mat', x: 4, y: 11, collide: false },
    ...
    { key: 'kenmi-military-campfire-pot-anim', x: 23, y: 21, collide: false },
    { key: 'kenmi-desert-props-desert-grass-props', x: 19, y: 22, collide: false, cropIndex: 1 },
    { key: 'kenmi-desert-props-desert-grass-props', x: 4, y: 23, collide: false, cropIndex: 0 },
    { key: 'kenmi-desert-props-desert-grass-props', x: 8, y: 23, collide: false, cropIndex: 1 },
    { key: 'kenmi-desert-props-desert-fern', x: 4, y: 18, collide: false },
    ...
    { key: 'kenmi-military-campfire-pot-anim', x: 14, y: 12, collide: false },
    ...
    { key: 'kenmi-desert-props-desert-fern', x: 31, y: 7, collide: false },
...
const mountain_village = {
  ...
  objects: [
    ...
    { key: 'kenmi-base-buildings-buildings-houses-limestone-house-2-limestone-base-red', x: 1, y: 24, collide: true, collideW: 32, collideH: 24 },
    { key: 'kenmi-base-buildings-buildings-houses-stone-house-2-stone-base-blue', x: 6, y: 28, collide: true, collideW: 32, collideH: 24 },
    { key: 'kenmi-base-buildings-buildings-houses-limestone-house-3-limestone-base-blue', x: 15, y: 28, collide: true, collideW: 32, collideH: 24 },
    { key: 'kenmi-base-buildings-buildings-houses-stone-house-4-stone-base-red', x: 27, y: 28, collide: true, collideW: 32, collideH: 24 },
    { key: 'kenmi-base-buildings-buildings-houses-limestone-house-5-limestone-base-black', x: 36, y: 28, collide: true, collideW: 32, collideH: 24 },
    { key: 'kenmi-base-buildings-buildings-houses-stone-house-5-stone-green-blue', x: 20, y: 28, collide: true, collideW: 24, collideH: 20 },
    ...
    { key: 'kenmi-base-outdoor-decoration-well', x: 20, y: 25, collide: false },
    { key: 'kenmi-base-buildings-buildings-unique-buildings-stalls-market-stalls', x: 16, y: 24, collide: false },
    { key: 'kenmi-base-buildings-buildings-unique-buildings-stalls-market-stalls', x: 25, y: 24, collide: false },
    { key: 'kenmi-desert-props-desert-rugs', x: 16, y: 25, collide: false, cropIndex: 1 },
    { key: 'kenmi-base-outdoor-decoration-stone-fence-small', x: 34, y: 20, collide: false },
    { key: 'kenmi-base-outdoor-decoration-minecrats', x: 28, y: 14, collide: false },
    { key: 'kenmi-base-outdoor-decoration-ores', x: 25, y: 13, collide: false, cropIndex: 9 },
    { key: 'kenmi-base-outdoor-decoration-ores', x: 25, y: 14, collide: false, cropIndex: 18 },
...
const coastal_port = {
  ...
  objects: [
    { key: 'kenmi-base-buildings-buildings-unique-buildings-inn-inn-blue', x: 15, y: 21, collide: true, collideW: 96, collideH: 64 },
    { key: 'kenmi-base-buildings-buildings-houses-stone-house-3-stone-base-blue', x: 23, y: 21, collide: true, collideW: 64, collideH: 48 },
    { key: 'kenmi-base-buildings-buildings-unique-buildings-blacksmith-house-blacksmith-house-blue', x: 10, y: 26, collide: true, collideW: 64, collideH: 48 },
    { key: 'kenmi-base-buildings-buildings-unique-buildings-fisherman-house-fisherman-house-base-blue', x: 4, y: 6, collide: true, collideW: 64, collideH: 64 },
    { key: 'kenmi-base-buildings-buildings-unique-buildings-fisherman-house-fisherman-house-base-red', x: 14, y: 6, collide: true, collideW: 64, collideH: 64 },
    { key: 'kenmi-base-buildings-buildings-unique-buildings-fisherman-house-fisherman-house-green-blue', x: 24, y: 6, collide: true, collideW: 64, collideH: 64 },
    { key: 'kenmi-base-buildings-buildings-unique-buildings-fisherman-house-fisherman-house-base-red', x: 4, y: 14, collide: false },
    { key: 'kenmi-base-buildings-buildings-unique-buildings-fisherman-house-fisherman-house-base-blue', x: 24, y: 14, collide: false },
    { key: 'kenmi-base-buildings-buildings-unique-buildings-fisherman-house-fisherman-house-green-blue', x: 4, y: 21, collide: false },
    { key: 'kenmi-base-buildings-buildings-unique-buildings-fisherman-house-fisherman-house-base-red', x: 28, y: 14, collide: false },
    { key: 'kenmi-base-buildings-buildings-unique-buildings-fisherman-house-fisherman-house-base-blue', x: 28, y: 21, collide: false },
    { key: 'kenmi-base-buildings-buildings-unique-buildings-fisherman-house-fisherman-house-green-blue', x: 4, y: 31, collide: false },
    { key: 'kenmi-base-buildings-buildings-unique-buildings-fisherman-house-fisherman-house-base-red', x: 24, y: 31, collide: false },
    { key: 'kenmi-base-buildings-buildings-unique-buildings-fisherman-house-fisherman-house-base-blue', x: 32, y: 14, collide: false },
    { key: 'kenmi-base-buildings-buildings-houses-stone-house-3-stone-base-blue', x: 12, y: 31, collide: false },
    { key: 'kenmi-base-buildings-buildings-houses-stone-house-3-stone-base-blue', x: 28, y: 27, collide: false },
    { key: 'kenmi-base-buildings-buildings-unique-buildings-blacksmith-house-blacksmith-house-blue', x: 17, y: 31, collide: false },
    { key: 'kenmi-volcano-buildings-volcano-tower', x: 42, y: 29, collide: false },
    { key: 'kenmi-base-outdoor-decoration-boat', x: 36, y: 11, collide: false },
    { key: 'kenmi-base-outdoor-decoration-boat', x: 36, y: 22, collide: false },
    { key: 'kenmi-base-outdoor-decoration-boat', x: 33, y: 33, collide: false, cropIndex: 1 },
    { key: 'kenmi-base-buildings-buildings-unique-buildings-stalls-market-stalls', x: 13, y: 12, collide: false, cropIndex: 2 },
    { key: 'kenmi-base-buildings-buildings-unique-buildings-stalls-market-stalls', x: 18, y: 10, collide: false, cropIndex: 3 },
    { key: 'kenmi-desert-props-desert-pots-sacks', x: 18, y: 18, collide: false, cropIndex: 0 },
    { key: 'kenmi-desert-props-desert-pots-sacks', x: 18, y: 20, collide: false, cropIndex: 4 },
    { key: 'kenmi-base-outdoor-decoration-barrels', x: 29, y: 17, collide: false },
    { key: 'kenmi-base-outdoor-decoration-barrels', x: 31, y: 23, collide: false },
  ],
...
const royal_palace = {
  ...
  // Rebuilt to the approved design (docs/world-designs/royal_palace.md §3/§5/§7).
  // Ground/collision/exits live in the authored Tiled map (sea, cliff/dune bands,
  // walls, hedges-on-curb, pavement, garden grass painted as tiles; B/o/T cells
  // carry painted Collision). These sprites dress it. Deviations (design doc
  // appendix): entrance torch pair ships as fire-pit braziers (big-torch/torch-anim
  // are spritesheets with no ANIMATED_DECO_PROPS entry; lanter-posts is an
  // uncropped multi-item sheet); the SW groom vignette ships camel-less (no
  // PROP_CROP_REGIONS row — oasis/marketplace precedent); facade banners deferred
  // to screenshot judgement.
  objects: [
    // Palace massing composite (B cells x17-32 y4-9, MISSING-ASSETS #2): temple
    // facade centred on the door axis x25, 3-tile limestone wings flush left and
    // right, small obelisk pair marking the back court, tall minarets on the o
    // cells. Colliders are thin base strips — the map Collision layer owns the
    // real footprint; nothing covers the door tile (25,10) or its front row.
    { key: 'kenmi-desert-temple-desert-temple', x: 25, y: 9, collide: true, collideW: 240, collideH: 24 },
    { key: 'kenmi-desert-houses-desert-house-2.2', x: 18, y: 8, collide: true, collideW: 180, collideH: 24 },
    { key: 'kenmi-desert-houses-desert-house-2.4', x: 21, y: 8, collide: true, collideW: 180, collideH: 24 },
    { key: 'kenmi-desert-houses-desert-house-2.3', x: 29, y: 8, collide: true, collideW: 180, collideH: 24 },
    { key: 'kenmi-desert-houses-desert-house-2.1', x: 32, y: 8, collide: true, collideW: 180, collideH: 24 },
    { key: 'kenmi-desert-temple-desert-obelisk-small-1', x: 24, y: 5, collide: true, collideW: 40, collideH: 20 },
    { key: 'kenmi-desert-temple-desert-obelisk-small-2', x: 26, y: 5, collide: true, collideW: 40, collideH: 20 },
    { key: 'kenmi-desert-temple-desert-obelisk-1', x: 16, y: 4, collide: true, collideW: 40, collideH: 20 },
    { key: 'kenmi-desert-temple-desert-obelisk-2', x: 33, y: 4, collide: true, collideW: 40, collideH: 20 },
    // Inner-gate pillar pair (o 22,20 / 28,20 — short so the statue pair at y19
    // stays readable behind them; the flag pair was cut for the LAW-31 budget)
    { key: 'kenmi-desert-temple-desert-obelisk-small-1', x: 22, y: 20, collide: true, collideW: 40, collideH: 20 },
    { key: 'kenmi-desert-temple-desert-obelisk-small-2', x: 28, y: 20, collide: true, collideW: 40, collideH: 20 },
    // Gate towers (o 23,33 / 27,33) — the VectoRaith twin-tower gate
    { key: 'kenmi-desert-temple-desert-obelisk-1', x: 23, y: 33, collide: true, collideW: 40, collideH: 20 },
    { key: 'kenmi-desert-temple-desert-obelisk-1', x: 27, y: 33, collide: true, collideW: 40, collideH: 20 },
    // Palms on the grid's T cells (all painted Collision): NW/NE shore triangles,
    // lone strip palms (LAW-33/45), hedge-run breaks (LAW-43), garden accents,
    // SE quiet grove, gate approach pair (LAW-28/42). Variants alternate (LAW-35).
    { key: 'kenmi-desert-props-palm-tree-1', x: 4, y: 5, collide: true, collideW: 30, collideH: 20 },
    { key: 'kenmi-desert-props-palm-tree-2', x: 6, y: 5, collide: true, collideW: 20, collideH: 16 },
    { key: 'kenmi-desert-props-palm-tree-1', x: 5, y: 6, collide: true, collideW: 30, collideH: 20 },
    { key: 'kenmi-desert-props-palm-tree-2', x: 37, y: 5, collide: true, collideW: 20, collideH: 16 },
    { key: 'kenmi-desert-props-palm-tree-1', x: 39, y: 5, collide: true, collideW: 30, collideH: 20 },
    { key: 'kenmi-desert-props-palm-tree-2', x: 38, y: 6, collide: true, collideW: 20, collideH: 16 },
    { key: 'kenmi-desert-props-palm-tree-1', x: 8, y: 17, collide: true, collideW: 30, collideH: 20 },
    { key: 'kenmi-desert-props-palm-tree-2', x: 39, y: 17, collide: true, collideW: 20, collideH: 16 },
    { key: 'kenmi-desert-props-palm-tree-1', x: 10, y: 21, collide: true, collideW: 30, collideH: 20 },
    { key: 'kenmi-desert-props-palm-tree-2', x: 38, y: 21, collide: true, collideW: 20, collideH: 16 },
    { key: 'kenmi-desert-props-palm-tree-2', x: 5, y: 22, collide: true, collideW: 20, collideH: 16 },
    { key: 'kenmi-desert-props-palm-tree-1', x: 12, y: 23, collide: true, collideW: 30, collideH: 20 },
    { key: 'kenmi-desert-props-palm-tree-1', x: 36, y: 23, collide: true, collideW: 30, collideH: 20 },
    { key: 'kenmi-desert-props-palm-tree-2', x: 3, y: 25, collide: true, collideW: 20, collideH: 16 },
    { key: 'kenmi-desert-props-palm-tree-2', x: 42, y: 26, collide: true, collideW: 20, collideH: 16 },
    { key: 'kenmi-desert-props-palm-tree-2', x: 13, y: 27, collide: true, collideW: 20, collideH: 16 },
    { key: 'kenmi-desert-props-palm-tree-1', x: 37, y: 28, collide: true, collideW: 30, collideH: 20 },
    { key: 'kenmi-desert-props-palm-tree-1', x: 9, y: 29, collide: true, collideW: 30, collideH: 20 },
    { key: 'kenmi-desert-props-palm-tree-2', x: 38, y: 29, collide: true, collideW: 20, collideH: 16 },
    { key: 'kenmi-desert-props-palm-tree-1', x: 43, y: 29, collide: true, collideW: 30, collideH: 20 },
    { key: 'kenmi-desert-props-palm-tree-2', x: 41, y: 30, collide: true, collideW: 20, collideH: 16 },
    { key: 'kenmi-desert-props-palm-tree-1', x: 21, y: 37, collide: true, collideW: 30, collideH: 20 },
    { key: 'kenmi-desert-props-palm-tree-2', x: 29, y: 37, collide: true, collideW: 20, collideH: 16 },
    // Entrance brazier pair (design's torch pair at (22,36)/(28,36), LAW-36)
    { key: 'kenmi-desert-props-fire-pit', x: 22, y: 36, collide: false, cropIndex: 3 },
    { key: 'kenmi-desert-props-fire-pit', x: 28, y: 36, collide: false, cropIndex: 5 },
    // Rugs (LINT-3 flat): throne threshold (LAW-38) + imam's prayer rug
    { key: 'kenmi-desert-props-desert-rugs', x: 25, y: 11, collide: false, cropIndex: 1 },
    { key: 'kenmi-desert-props-desert-rugs', x: 9, y: 27, collide: false, cropIndex: 4 },
    // Terrace riches flanking the scholar alcoves
    { key: 'kenmi-desert-props-golden-pots', x: 17, y: 10, collide: false, cropIndex: 0 },
    { key: 'kenmi-desert-props-golden-pots', x: 33, y: 11, collide: false, cropIndex: 1 },
    // West prayer garden dressing
    { key: 'kenmi-base-outdoor-decoration-flowers', x: 11, y: 25, collide: false, cropIndex: 21 },
    { key: 'kenmi-base-outdoor-decoration-flowers', x: 6, y: 26, collide: false, cropIndex: 49 },
    { key: 'kenmi-base-outdoor-decoration-benches', x: 6, y: 24, collide: false, cropIndex: 1 },
    // East poet's garden dressing (pergola beside the poetry shelf — on the
    // shelf's own tile (42,22) its canopy occluded the contract bookshelf)
    { key: 'kenmi-desert-houses-pergola', x: 41, y: 22, collide: false },
    { key: 'kenmi-base-outdoor-decoration-flowers', x: 33, y: 23, collide: false, cropIndex: 21 },
    { key: 'kenmi-base-outdoor-decoration-flowers', x: 39, y: 26, collide: false, cropIndex: 12 },
    { key: 'kenmi-base-outdoor-decoration-benches', x: 34, y: 25, collide: false, cropIndex: 1 },
    // SW service corner — camel-groom vignette minus the camel (LAW-34)
    { key: 'kenmi-base-outdoor-decoration-water-troughs', x: 5, y: 30, collide: false },
    { key: 'kenmi-desert-props-desert-rugs', x: 5, y: 31, collide: false, cropIndex: 2 },
    { key: 'kenmi-desert-props-desert-pots-sacks', x: 7, y: 31, collide: false, cropIndex: 0 },
    { key: 'kenmi-desert-props-water-sack-on-stick', x: 3, y: 30, collide: false },
    // LAW-43 wall-run breaks — jar clusters at the wall bases
    { key: 'kenmi-desert-props-desert-pots-sacks', x: 3, y: 8, collide: false, cropIndex: 1 },
    { key: 'kenmi-desert-props-desert-pots-sacks', x: 3, y: 16, collide: false, cropIndex: 2 },
    { key: 'kenmi-desert-props-desert-pots-sacks', x: 45, y: 31, collide: false, cropIndex: 4 },
    // East vista strip + clifftop rest spot (LAW-46; inscription at (44,12))
    { key: 'kenmi-base-outdoor-decoration-benches', x: 43, y: 13, collide: false, cropIndex: 1 },
    { key: 'kenmi-desert-props-desert-rocks', x: 42, y: 8, collide: false, cropIndex: 1 },
    { key: 'kenmi-desert-props-desert-grass-props', x: 43, y: 17, collide: false, cropIndex: 2 },
    { key: 'kenmi-desert-props-desert-rocks', x: 36, y: 15, collide: false, cropIndex: 3 },
    // West flank sand rhythm (LAW-33)
    { key: 'kenmi-desert-props-desert-rocks', x: 4, y: 12, collide: false, cropIndex: 2 },
    { key: 'kenmi-desert-props-desert-grass-props', x: 11, y: 7, collide: false, cropIndex: 0 },
    { key: 'kenmi-desert-props-desert-bones', x: 6, y: 19, collide: false, cropIndex: 1 },
    // Shore walk accent (west; the east shore's POI rhythm is carried by the
    // NE palm triangle — a second rock at (28,3) tipped the LAW-31 window to 16)
    { key: 'kenmi-desert-props-desert-rocks', x: 10, y: 3, collide: false, cropIndex: 9 },
    // Gate apron rhythm (LAW-33)
    { key: 'kenmi-desert-props-desert-bones', x: 12, y: 35, collide: false, cropIndex: 1 },
    { key: 'kenmi-desert-props-desert-rocks', x: 17, y: 36, collide: false, cropIndex: 11 },
    { key: 'kenmi-desert-props-desert-grass-props', x: 33, y: 36, collide: false, cropIndex: 1 },
  ],

  npcs: [
    { id: 'vizier-abbas', key: 'npc-vizier-abbas', name: 'Vizier Abbas', nameArabic: 'الوَزير عَبّاس', x: 23, y: 15 },
    { id: 'princess-aisha', key: 'npc-princess-aisha', name: 'Princess Aisha', nameArabic: 'الأَميرَة عائِشَة', x: 37, y: 26 },
    { id: 'poet-rumi', key: 'npc-poet-rumi', name: 'Poet Rumi', nameArabic: 'الشّاعِر الرّومي', x: 40, y: 24 },
    { id: 'imam-muhammad', key: 'npc-imam-muhammad', name: 'Imam Muhammad', nameArabic: 'الإمام مُحَمَّد', x: 9, y: 27 },
  ],

  interactables: [
    { id: 'sign-palace', type: 'sign', x: 28, y: 35, textArabic: 'القَصر المَلَكي', textEnglish: 'The Royal Palace' },
    { id: 'sign-throne', type: 'sign', x: 23, y: 12, textArabic: 'قاعَة العَرش', textEnglish: 'Throne Room' },
    { id: 'sign-garden', type: 'sign', x: 28, y: 21, textArabic: 'الحَديقَة', textEnglish: 'The Garden' },
    { id: 'bookshelf-palace-adj', type: 'bookshelf', x: 18, y: 10, category: 'adjectives' },
    { id: 'bookshelf-palace-colors', type: 'bookshelf', x: 32, y: 10, category: 'colors' },
    { id: 'bookshelf-palace-phrases', type: 'bookshelf', x: 42, y: 22, category: 'phrases' },
    { id: 'chest-palace-throne', type: 'chest', x: 16, y: 11, minDirhams: 60, maxDirhams: 200 },
    { id: 'chest-palace-garden', type: 'chest', x: 43, y: 27, minDirhams: 50, maxDirhams: 180 },
    ...
    // --- Phase 23: Interactive Objects ---
    { id: 'fountain-palace-1', type: 'fountain', x: 38, y: 24, labelArabic: 'نافورة', labelEnglish: 'Royal Fountain', descriptionEnglish: 'A magnificent central fountain surrounded by marble, its waters sparkling in the sunlight.', descriptionArabic: 'نافورة ملكية رائعة محاطة بالرخام.', culturalNote: 'Palace fountains in Islamic architecture represent paradise (jannah), with gardens built around four water channels.', vocabWordId: 'excuse_me_1', vocabCategory: 'phrases', repeatable: true },
    { id: 'fountain-palace-2', type: 'fountain', x: 9, y: 25, labelArabic: 'نافورة', labelEnglish: 'Garden Fountain', descriptionEnglish: 'A small fountain in the west garden, its gentle sound soothing visiting dignitaries.', vocabWordId: 'color_white', vocabCategory: 'colors', repeatable: true },
    { id: 'painting-palace-1', type: 'painting', x: 21, y: 10, labelArabic: 'لوحة', labelEnglish: 'Royal Portrait', descriptionEnglish: 'A grand portrait of the palace founder, adorned in gold and lapis lazuli.', culturalNote: 'Lapis lazuli was imported from Afghanistan and prized across the Islamic world for its vivid blue colour.', vocabWordId: 'color_golden', vocabCategory: 'colors', repeatable: true },
    { id: 'painting-palace-2', type: 'painting', x: 29, y: 10, labelArabic: 'لوحة', labelEnglish: 'Battle Painting', descriptionEnglish: 'A sweeping painting of a great battle with horses, banners, and desert dunes.', vocabWordId: 'brave_1', vocabCategory: 'adjectives', repeatable: true },
    { id: 'painting-palace-3', type: 'painting', x: 35, y: 22, labelArabic: 'لوحة', labelEnglish: 'Garden Mosaic', descriptionEnglish: 'An intricate mosaic panel depicting flowers, birds, and flowing water in the garden.', culturalNote: 'Islamic geometric art avoids depicting living beings, instead celebrating nature through patterns and arabesques.', vocabWordId: 'color_red', vocabCategory: 'colors', repeatable: true },
    { id: 'painting-palace-4', type: 'painting', x: 41, y: 27, labelArabic: 'لوحة', labelEnglish: 'Calligraphy Panel', descriptionEnglish: 'A stunning calligraphy panel with gold leaf, displaying a poem about wisdom and justice.', vocabWordId: 'good_morning_1', vocabCategory: 'phrases', repeatable: true },
    { id: 'lantern-palace-1', type: 'lantern', x: 23, y: 14, labelArabic: 'فانوس', labelEnglish: 'Ornate Lantern', descriptionEnglish: 'A jewel-encrusted lantern of hammered brass casting intricate shadow patterns on the courtyard walls.', culturalNote: 'Mashrabiya lanterns create geometric light patterns, a signature of Islamic decorative arts.', vocabWordId: 'color_purple', vocabCategory: 'colors', repeatable: true },
    { id: 'lantern-palace-2', type: 'lantern', x: 27, y: 14, labelArabic: 'فانوس', labelEnglish: 'Ornate Lantern', descriptionEnglish: 'A matching ornate lantern on the eastern side of the grand gate.', vocabWordId: 'color_silver', vocabCategory: 'colors', repeatable: true },
    { id: 'lantern-palace-3', type: 'lantern', x: 28, y: 32, labelArabic: 'فانوس', labelEnglish: 'Entrance Lantern', descriptionEnglish: 'A tall golden lantern illuminating the grand entrance path to the palace.', vocabWordId: 'goodbye_1', vocabCategory: 'phrases', repeatable: true },
    { id: 'statue-palace-1', type: 'statue', x: 22, y: 19, labelArabic: 'تمثال', labelEnglish: 'Lion Statue', descriptionEnglish: 'A majestic stone lion guarding the west side of the grand gate.', culturalNote: 'Lions symbolise power and sovereignty in Islamic art, often guarding palace entrances.', vocabWordId: 'big_1', vocabCategory: 'adjectives', repeatable: true },
    { id: 'statue-palace-2', type: 'statue', x: 28, y: 19, labelArabic: 'تمثال', labelEnglish: 'Lion Statue', descriptionEnglish: 'A matching lion statue guarding the east side of the grand gate.', vocabWordId: 'tall_1', vocabCategory: 'adjectives', repeatable: true },
    { id: 'crate-palace-1', type: 'crate', x: 4, y: 31, labelArabic: 'صندوق', labelEnglish: 'Treasure Crate', descriptionEnglish: 'A gilded crate containing tribute gifts from distant provinces: gold, jewels, and silk.', vocabWordId: 'color_yellow', vocabCategory: 'colors', loot: { type: 'dirhams', min: 20, max: 50 }, repeatable: false, stateChange: 'inspected' },
    { id: 'crate-palace-2', type: 'crate', x: 6, y: 32, labelArabic: 'صندوق', labelEnglish: 'Treasure Crate', descriptionEnglish: 'Another tribute crate, this one filled with rare manuscripts and astronomical instruments.', vocabWordId: 'i_speak_arabic_1', vocabCategory: 'phrases', loot: { type: 'dirhams', min: 25, max: 60 }, repeatable: false, stateChange: 'inspected' },
    { id: 'pot-palace-1', type: 'pot', x: 23, y: 10, labelArabic: 'قِدر', labelEnglish: 'Rose Water Pot', descriptionEnglish: 'A pot of rose water used to perfume the palace gardens and receiving halls.', culturalNote: 'Rose water (ma ward) has been distilled in the Arab world since the 8th century.', vocabWordId: 'color_pink', vocabCategory: 'colors', repeatable: true },
    { id: 'pot-palace-2', type: 'pot', x: 27, y: 10, labelArabic: 'قِدر', labelEnglish: 'Incense Pot', descriptionEnglish: 'A pot burning oud incense, filling the garden with a rich, woody fragrance.', culturalNote: 'Oud (agarwood) is called "liquid gold" in the Arab world and has been prized for over 3000 years.', vocabWordId: 'good_evening_1', vocabCategory: 'phrases', repeatable: true },
    // --- Phase 45: Hidden inscription (root family discovery) ---
    {
