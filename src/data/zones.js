...
const oasis_village = {
  ...
  interactables: [
    ...
    { id: 'fountain-oasis-1', type: 'fountain', x: 20, y: 9, labelArabic: 'نافورة', labelEnglish: 'Fountain', descriptionEnglish: 'A welcome fountain at the heart of the oasis. Its waters have refreshed travellers for centuries.', descriptionArabic: 'نافورة ترحيب في قلب الواحة.', culturalNote: 'Fountains in Arabian villages symbolise hospitality and the life-giving nature of water in the desert.', vocabWordId: null, vocabCategory: 'greetings', repeatable: true },
    { id: 'lantern-oasis-1', type: 'lantern', x: 6, y: 10, labelArabic: 'فانوس', labelEnglish: 'Lantern', descriptionEnglish: 'A brass lantern hanging from a palm, casting warm light across the village path.', culturalNote: 'Fanous lanterns are lit during Ramadan across the Arab world, symbolising guidance.', vocabWordId: null, vocabCategory: null, repeatable: true },
    { id: 'lantern-oasis-2', type: 'lantern', x: 34, y: 13, labelArabic: 'فانوس', labelEnglish: 'Lantern', descriptionEnglish: 'An ornate village lantern illuminating the road to the large house.', vocabWordId: null, vocabCategory: null, repeatable: true },
    { id: 'statue-oasis-1', type: 'statue', x: 22, y: 5, labelArabic: 'تمثال', labelEnglish: 'Statue', descriptionEnglish: 'A weathered stone statue near the ancient ruins, depicting a scribe holding a scroll.', culturalNote: 'Scribes preserved knowledge across the medieval Islamic world through meticulous calligraphy.', vocabWordId: null, vocabCategory: 'greetings', repeatable: true },
    { id: 'stall-oasis-1', type: 'stall', x: 11, y: 12, labelArabic: 'دكان', labelEnglish: 'Market Stall', descriptionEnglish: 'A small trading stall displaying dried fruits and simple goods.', descriptionArabic: 'دكان صغير يعرض الفواكه المجففة.', vocabWordId: null, vocabCategory: 'trade', repeatable: true },
    { id: 'barrel-oasis-1', type: 'barrel', x: 14, y: 15, labelArabic: 'برميل', labelEnglish: 'Barrel', descriptionEnglish: 'A wooden barrel filled with fresh oasis water for travellers.', vocabWordId: null, vocabCategory: null, loot: { type: 'dirhams', min: 3, max: 8 }, repeatable: false, stateChange: 'inspected' },
    { id: 'pot-oasis-1', type: 'pot', x: 31, y: 25, labelArabic: 'قِدر', labelEnglish: 'Pot', descriptionEnglish: 'A clay cooking pot simmering with lentil stew. The smell is inviting.', culturalNote: 'Lentil stew (shorbat adas) is a staple across the Arab world, often served to welcome guests.', vocabWordId: null, vocabCategory: 'trade', repeatable: true },
    { id: 'crate-oasis-1', type: 'crate', x: 37, y: 22, labelArabic: 'صندوق', labelEnglish: 'Crate', descriptionEnglish: 'A wooden crate packed with traded goods from the marketplace.', vocabWordId: null, vocabCategory: null, loot: { type: 'dirhams', min: 5, max: 12 }, repeatable: false, stateChange: 'inspected' },
    { id: 'painting-oasis-1', type: 'painting', x: 4, y: 6, labelArabic: 'لوحة', labelEnglish: 'Painting', descriptionEnglish: 'A faded mural on the house wall showing the oasis surrounded by palm trees.', vocabWordId: null, vocabCategory: null, repeatable: true },
    { id: 'barrel-oasis-2', type: 'barrel', x: 26, y: 12, labelArabic: 'برميل', labelEnglish: 'Barrel', descriptionEnglish: 'A sealed barrel of dates stored near the oasis for trade.', vocabWordId: null, vocabCategory: 'trade', repeatable: true },
    { id: 'lantern-oasis-3', type: 'lantern', x: 16, y: 24, labelArabic: 'فانوس', labelEnglish: 'Lantern', descriptionEnglish: 'A ground lantern marking the southern village path.', vocabWordId: null, vocabCategory: null, repeatable: true },
    { id: 'pot-oasis-2', type: 'pot', x: 9, y: 9, labelArabic: 'قِدر', labelEnglish: 'Pot', descriptionEnglish: 'A decorative clay pot filled with aromatic herbs.', vocabWordId: null, vocabCategory: null, repeatable: true },
  ],
...
const ancient_library = {
  ...
  interactables: [
    ...
    // --- Phase 23: Interactive Objects ---
    { id: 'fountain-library-1', type: 'fountain', x: 17, y: 13, labelArabic: 'نافورة', labelEnglish: 'Reflecting Pool Fountain', descriptionEnglish: 'A serene fountain feeding the reflecting pool. Scholars meditate by its gentle sound.', descriptionArabic: 'نافورة هادئة تغذي البركة.', culturalNote: 'Reflecting pools in Islamic architecture symbolise paradise and contemplation.', vocabWordId: null, vocabCategory: 'phrases', repeatable: true },
    { id: 'statue-library-1', type: 'statue', x: 15, y: 15, labelArabic: 'تمثال', labelEnglish: 'Statue of Knowledge', descriptionEnglish: 'A stone statue of a seated scholar with an open book, representing the pursuit of knowledge.', culturalNote: 'The Arabic word for knowledge (ilm) appears over 750 times in the Quran.', vocabWordId: null, vocabCategory: 'numbers', repeatable: true },
    { id: 'statue-library-2', type: 'statue', x: 19, y: 15, labelArabic: 'تمثال', labelEnglish: 'Statue of the Astronomer', descriptionEnglish: 'A marble figure gazing at the sky, holding an astrolabe.', culturalNote: 'Arab astronomers invented the astrolabe and named many stars still known today.', vocabWordId: null, vocabCategory: 'numbers', repeatable: true },
    { id: 'painting-library-1', type: 'painting', x: 12, y: 9, labelArabic: 'لوحة', labelEnglish: 'Ancient Painting', descriptionEnglish: 'A richly detailed painting depicting the founding of the great library.', vocabWordId: null, vocabCategory: null, repeatable: true },
    { id: 'painting-library-2', type: 'painting', x: 22, y: 9, labelArabic: 'لوحة', labelEnglish: 'Calligraphy Painting', descriptionEnglish: 'An ornate calligraphy panel with verses about seeking knowledge.', culturalNote: 'Arabic calligraphy is considered one of the highest art forms in Islamic culture.', vocabWordId: null, vocabCategory: 'phrases', repeatable: true },
    { id: 'lantern-library-1', type: 'lantern', x: 11, y: 17, labelArabic: 'فانوس', labelEnglish: 'Scholar Lantern', descriptionEnglish: 'A tall brass lantern illuminating the courtyard. Its flame never seems to wane.', vocabWordId: null, vocabCategory: null, repeatable: true },
    { id: 'lantern-library-2', type: 'lantern', x: 23, y: 17, labelArabic: 'فانوس', labelEnglish: 'Scholar Lantern', descriptionEnglish: 'A matching brass lantern on the east side of the courtyard.', vocabWordId: null, vocabCategory: null, repeatable: true },
    { id: 'lantern-library-3', type: 'lantern', x: 17, y: 26, labelArabic: 'فانوس', labelEnglish: 'Garden Path Lantern', descriptionEnglish: 'A small lantern lighting the garden path to the library gate.', vocabWordId: null, vocabCategory: null, repeatable: true },
    { id: 'crate-library-1', type: 'crate', x: 9, y: 10, labelArabic: 'صندوق', labelEnglish: 'Manuscript Crate', descriptionEnglish: 'A sealed crate of ancient manuscripts awaiting cataloguing.', vocabWordId: null, vocabCategory: 'colors', loot: { type: 'dirhams', min: 8, max: 20 }, repeatable: false, stateChange: 'inspected' },
    { id: 'barrel-library-1', type: 'barrel', x: 25, y: 10, labelArabic: 'برميل', labelEnglish: 'Ink Barrel', descriptionEnglish: 'A barrel of fine ink used by scribes for copying manuscripts.', culturalNote: 'Medieval Arab scribes used ink made from soot, gum arabic, and water.', vocabWordId: null, vocabCategory: null, repeatable: true },
    { id: 'pot-library-1', type: 'pot', x: 14, y: 19, labelArabic: 'قِدر', labelEnglish: 'Incense Pot', descriptionEnglish: 'A clay pot burning frankincense, filling the courtyard with a sacred aroma.', culturalNote: 'Frankincense from the Arabian Peninsula has been traded for over 5000 years.', vocabWordId: null, vocabCategory: null, repeatable: true },
    { id: 'pot-library-2', type: 'pot', x: 20, y: 19, labelArabic: 'قِدر', labelEnglish: 'Herbal Pot', descriptionEnglish: 'A pot of dried herbs used by scholars to stay alert during long study sessions.', vocabWordId: null, vocabCategory: null, repeatable: true },
  ],
...
const desert_marketplace = {
  ...
  interactables: [
    ...
    // --- Phase 23: Interactive Objects ---
    { id: 'fountain-market-1', type: 'fountain', x: 22, y: 14, labelArabic: 'نافورة', labelEnglish: 'Market Fountain', descriptionEnglish: 'The central market fountain where merchants gather to trade news and haggle prices.', descriptionArabic: 'نافورة السوق المركزية حيث يجتمع التجار.', culturalNote: 'Souks (markets) have been the heart of Arab commerce and social life for millennia.', vocabWordId: null, vocabCategory: 'trade', repeatable: true },
    { id: 'stall-market-1', type: 'stall', x: 18, y: 16, labelArabic: 'دكان', labelEnglish: 'Fruit Stall', descriptionEnglish: 'A bustling stall overflowing with dates, figs, and pomegranates.', culturalNote: 'Dates are mentioned over 20 times in the Quran and are a symbol of generosity.', vocabWordId: null, vocabCategory: 'food', repeatable: true },
    { id: 'stall-market-2', type: 'stall', x: 26, y: 16, labelArabic: 'دكان', labelEnglish: 'Jewellery Stall', descriptionEnglish: 'A glittering display of silver rings, amber necklaces, and turquoise bracelets.', vocabWordId: null, vocabCategory: 'trade', repeatable: true },
    { id: 'stall-market-3', type: 'stall', x: 18, y: 20, labelArabic: 'دكان', labelEnglish: 'Pottery Stall', descriptionEnglish: 'Hand-painted ceramic bowls and plates stacked in colourful towers.', culturalNote: 'Arab pottery traditions date back thousands of years, with distinctive geometric patterns.', vocabWordId: null, vocabCategory: 'numbers', repeatable: true },
    { id: 'stall-market-4', type: 'stall', x: 26, y: 20, labelArabic: 'دكان', labelEnglish: 'Cloth Stall', descriptionEnglish: 'Bolts of silk and cotton in every colour, imported from distant lands.', vocabWordId: null, vocabCategory: 'trade', repeatable: true },
    { id: 'barrel-market-1', type: 'barrel', x: 13, y: 15, labelArabic: 'برميل', labelEnglish: 'Spice Barrel', descriptionEnglish: 'A barrel brimming with saffron, the most expensive spice in the world.', culturalNote: 'Arab traders controlled the global spice trade for centuries along the Silk Road.', vocabWordId: null, vocabCategory: 'food', loot: { type: 'dirhams', min: 5, max: 15 }, repeatable: false, stateChange: 'inspected' },
    { id: 'barrel-market-2', type: 'barrel', x: 33, y: 15, labelArabic: 'برميل', labelEnglish: 'Oil Barrel', descriptionEnglish: 'A heavy barrel of olive oil destined for the coastal port.', vocabWordId: null, vocabCategory: 'trade', repeatable: true },
    { id: 'barrel-market-3', type: 'barrel', x: 20, y: 10, labelArabic: 'برميل', labelEnglish: 'Grain Barrel', descriptionEnglish: 'Barley and wheat stored for the market bakers.', vocabWordId: null, vocabCategory: 'food', repeatable: true },
    { id: 'pot-market-1', type: 'pot', x: 9, y: 18, labelArabic: 'قِدر', labelEnglish: 'Spice Pot', descriptionEnglish: 'A clay pot of ground cumin releasing a warm, earthy fragrance.', vocabWordId: null, vocabCategory: 'food', repeatable: true },
    { id: 'pot-market-2', type: 'pot', x: 35, y: 18, labelArabic: 'قِدر', labelEnglish: 'Dye Pot', descriptionEnglish: 'A pot of indigo dye used to colour the textiles sold next door.', vocabWordId: null, vocabCategory: null, repeatable: true },
    { id: 'crate-market-1', type: 'crate', x: 38, y: 11, labelArabic: 'صندوق', labelEnglish: 'Trade Crate', descriptionEnglish: 'A sealed shipping crate stamped with marks from the coastal port.', vocabWordId: null, vocabCategory: 'trade', loot: { type: 'dirhams', min: 10, max: 25 }, repeatable: false, stateChange: 'inspected' },
    { id: 'crate-market-2', type: 'crate', x: 6, y: 23, labelArabic: 'صندوق', labelEnglish: 'Storage Crate', descriptionEnglish: 'A wooden crate filled with dried herbs and medicinal roots.', vocabWordId: null, vocabCategory: 'food', repeatable: true },
    { id: 'lantern-market-1', type: 'lantern', x: 20, y: 15, labelArabic: 'فانوس', labelEnglish: 'Market Lantern', descriptionEnglish: 'A tall iron lantern marking the crossroads of the main market streets.', vocabWordId: null, vocabCategory: null, repeatable: true },
    { id: 'lantern-market-2', type: 'lantern', x: 24, y: 19, labelArabic: 'فانوس', labelEnglish: 'Market Lantern', descriptionEnglish: 'A hanging lantern swaying gently above the south market square.', vocabWordId: null, vocabCategory: null, repeatable: true },
  ],
...
const farmland = {
  ...
  interactables: [
    ...
    // --- Phase 23: Interactive Objects ---
    { id: 'pot-farm-1', type: 'pot', x: 8, y: 10, labelArabic: 'قِدر', labelEnglish: 'Cooking Pot', descriptionEnglish: 'A large iron pot bubbling with farm-fresh vegetable stew.', descriptionArabic: 'قدر كبير من الحساء بالخضار الطازجة.', culturalNote: 'Communal cooking pots are central to rural Arab hospitality, always ready for unexpected guests.', vocabWordId: null, vocabCategory: 'nature', repeatable: true },
    { id: 'pot-farm-2', type: 'pot', x: 16, y: 12, labelArabic: 'قِدر', labelEnglish: 'Herb Pot', descriptionEnglish: 'A clay pot growing fresh mint and basil for cooking.', vocabWordId: null, vocabCategory: 'nature', repeatable: true },
    { id: 'pot-farm-3', type: 'pot', x: 30, y: 23, labelArabic: 'قِدر', labelEnglish: 'Seed Pot', descriptionEnglish: 'A pot filled with seeds ready for the next planting season.', vocabWordId: null, vocabCategory: 'nature', repeatable: true },
    { id: 'barrel-farm-1', type: 'barrel', x: 14, y: 7, labelArabic: 'برميل', labelEnglish: 'Crop Barrel', descriptionEnglish: 'A barrel of freshly harvested wheat, golden and fragrant.', vocabWordId: null, vocabCategory: 'nature', loot: { type: 'dirhams', min: 5, max: 12 }, repeatable: false, stateChange: 'inspected' },
    { id: 'barrel-farm-2', type: 'barrel', x: 28, y: 8, labelArabic: 'برميل', labelEnglish: 'Water Barrel', descriptionEnglish: 'A barrel collecting irrigation water from the canal.', vocabWordId: null, vocabCategory: null, repeatable: true },
    { id: 'barrel-farm-3', type: 'barrel', x: 18, y: 28, labelArabic: 'برميل', labelEnglish: 'Fruit Barrel', descriptionEnglish: 'A barrel packed with ripe pomegranates from the orchard.', culturalNote: 'Pomegranates are mentioned in the Quran and symbolise abundance and prosperity.', vocabWordId: null, vocabCategory: 'nature', repeatable: true },
    { id: 'statue-farm-1', type: 'statue', x: 12, y: 22, labelArabic: 'تمثال', labelEnglish: 'Nature Statue', descriptionEnglish: 'A carved stone depicting a farmer sowing seeds under a crescent moon.', culturalNote: 'Traditional Arab farmers used the lunar calendar to determine planting seasons.', vocabWordId: null, vocabCategory: 'animals', repeatable: true },
    { id: 'fountain-farm-1', type: 'fountain', x: 38, y: 26, labelArabic: 'نافورة', labelEnglish: 'Pond Fountain', descriptionEnglish: 'A small stone fountain feeding the farm pond. Fish dart beneath the surface.', vocabWordId: null, vocabCategory: null, repeatable: true },
    { id: 'lantern-farm-1', type: 'lantern', x: 8, y: 17, labelArabic: 'فانوس', labelEnglish: 'Path Lantern', descriptionEnglish: 'A lantern marking the main farm path, lit at dusk by the farmer.', vocabWordId: null, vocabCategory: null, repeatable: true },
    { id: 'lantern-farm-2', type: 'lantern', x: 38, y: 17, labelArabic: 'فانوس', labelEnglish: 'Path Lantern', descriptionEnglish: 'A matching lantern on the eastern stretch of the farm path.', vocabWordId: null, vocabCategory: null, repeatable: true },
    { id: 'crate-farm-1', type: 'crate', x: 34, y: 6, labelArabic: 'صندوق', labelEnglish: 'Tool Crate', descriptionEnglish: 'A wooden crate holding farming tools: hoes, sickles, and rope.', vocabWordId: null, vocabCategory: null, loot: { type: 'dirhams', min: 4, max: 10 }, repeatable: false, stateChange: 'inspected' },
    { id: 'painting-farm-1', type: 'painting', x: 9, y: 24, labelArabic: 'لوحة', labelEnglish: 'Harvest Mural', descriptionEnglish: 'A cheerful mural painted on the farmhouse wall showing the autumn harvest.', vocabWordId: null, vocabCategory: null, repeatable: true },
    { id: 'stall-farm-1', type: 'stall', x: 25, y: 22, labelArabic: 'دكان', labelEnglish: 'Farm Stand', descriptionEnglish: 'A roadside stand selling fresh eggs, honey, and goat cheese.', vocabWordId: null, vocabCategory: 'animals', repeatable: true },
  ],
...
const bedouin_camp = {
  ...
  interactables: [
    ...
    // --- Phase 23: Interactive Objects ---
    { id: 'lantern-camp-1', type: 'lantern', x: 15, y: 11, labelArabic: 'فانوس', labelEnglish: 'Campfire Lantern', descriptionEnglish: 'A tall lantern beside the central campfire, casting dancing shadows across the sand.', descriptionArabic: 'فانوس طويل بجانب نار المخيم.', culturalNote: 'Bedouin campfires are the centre of storytelling, poetry, and hospitality under the stars.', vocabWordId: null, vocabCategory: 'time', repeatable: true },
    { id: 'lantern-camp-2', type: 'lantern', x: 19, y: 11, labelArabic: 'فانوس', labelEnglish: 'Campfire Lantern', descriptionEnglish: 'A matching lantern on the other side of the gathering circle.', vocabWordId: null, vocabCategory: null, repeatable: true },
    { id: 'lantern-camp-3', type: 'lantern', x: 6, y: 17, labelArabic: 'فانوس', labelEnglish: 'Tent Lantern', descriptionEnglish: 'A small hanging lantern at the entrance of the southern tent.', vocabWordId: null, vocabCategory: null, repeatable: true },
    { id: 'painting-camp-1', type: 'painting', x: 9, y: 7, labelArabic: 'لوحة', labelEnglish: 'Family Tapestry', descriptionEnglish: 'A woven tapestry depicting a Bedouin family travelling across the desert with their camels.', culturalNote: 'Bedouin families are organised into tribes and clans, with strong bonds of loyalty and kinship.', vocabWordId: null, vocabCategory: 'phrases', repeatable: true },
    { id: 'painting-camp-2', type: 'painting', x: 26, y: 7, labelArabic: 'لوحة', labelEnglish: 'Star Map', descriptionEnglish: 'A painted star map showing desert navigation routes used by Bedouin travellers.', culturalNote: 'Bedouins navigate the desert by reading the stars, a skill passed down through generations.', vocabWordId: null, vocabCategory: 'time', repeatable: true },
    { id: 'crate-camp-1', type: 'crate', x: 22, y: 9, labelArabic: 'صندوق', labelEnglish: 'Travel Crate', descriptionEnglish: 'A crate of supplies prepared for the next desert crossing.', vocabWordId: null, vocabCategory: 'adjectives', loot: { type: 'dirhams', min: 8, max: 18 }, repeatable: false, stateChange: 'inspected' },
    { id: 'crate-camp-2', type: 'crate', x: 10, y: 19, labelArabic: 'صندوق', labelEnglish: 'Provisions Crate', descriptionEnglish: 'Dried meat, flatbread, and water skins for the camp.', vocabWordId: null, vocabCategory: null, repeatable: true },
    { id: 'pot-camp-1', type: 'pot', x: 17, y: 15, labelArabic: 'قِدر', labelEnglish: 'Coffee Pot', descriptionEnglish: 'A traditional dallah coffee pot warming over the embers. The aroma of cardamom fills the air.', culturalNote: 'Arabic coffee (qahwa) with cardamom is a cornerstone of Bedouin hospitality. Refusing a cup is considered rude.', vocabWordId: null, vocabCategory: 'phrases', repeatable: true },
    { id: 'barrel-camp-1', type: 'barrel', x: 28, y: 9, labelArabic: 'برميل', labelEnglish: 'Water Barrel', descriptionEnglish: 'A precious barrel of water, the most valuable resource in the desert.', vocabWordId: null, vocabCategory: null, loot: { type: 'dirhams', min: 3, max: 8 }, repeatable: false, stateChange: 'inspected' },
    { id: 'statue-camp-1', type: 'statue', x: 20, y: 4, labelArabic: 'تمثال', labelEnglish: 'Wayfinder Stone', descriptionEnglish: 'An ancient carved stone used as a directional marker by desert travellers.', culturalNote: 'Stone cairns and markers guided caravans across the Arabian deserts long before compasses arrived.', vocabWordId: null, vocabCategory: 'adjectives', repeatable: true },
  ],
...
const mountain_village = {
  ...
  interactables: [
    ...
    // --- Phase 23: Interactive Objects ---
    { id: 'statue-mountain-1', type: 'statue', x: 20, y: 10, labelArabic: 'تمثال', labelEnglish: 'Mountain Guardian', descriptionEnglish: 'A tall carved statue of an ibex, the guardian spirit of the mountain village.', descriptionArabic: 'تمثال منحوت لوعل الجبل.', culturalNote: 'The Arabian ibex is a symbol of resilience and has lived in these mountains for thousands of years.', vocabWordId: null, vocabCategory: 'animals', repeatable: true },
    { id: 'statue-mountain-2', type: 'statue', x: 16, y: 14, labelArabic: 'تمثال', labelEnglish: 'Healer Statue', descriptionEnglish: 'A stone carving of a hand holding herbs, honouring the village healers.', vocabWordId: null, vocabCategory: 'clothing', repeatable: true },
    { id: 'painting-mountain-1', type: 'painting', x: 17, y: 19, labelArabic: 'لوحة', labelEnglish: 'Animal Mural', descriptionEnglish: 'A wall painting showing mountain goats, eagles, and foxes in their natural habitat.', culturalNote: 'Mountain villages in the Arab world often feature murals celebrating local wildlife.', vocabWordId: null, vocabCategory: 'animals', repeatable: true },
    { id: 'painting-mountain-2', type: 'painting', x: 24, y: 19, labelArabic: 'لوحة', labelEnglish: 'Weaving Pattern', descriptionEnglish: 'A decorative tile showing traditional geometric weaving patterns from the village.', vocabWordId: null, vocabCategory: 'clothing', repeatable: true },
    { id: 'pot-mountain-1', type: 'pot', x: 14, y: 12, labelArabic: 'قِدر', labelEnglish: 'Herbal Pot', descriptionEnglish: 'A pot of dried mountain herbs — thyme, sage, and chamomile — used for medicinal teas.', culturalNote: 'Traditional Arab herbal medicine (tibb) has been practised for over 1000 years.', vocabWordId: null, vocabCategory: 'adjectives', repeatable: true },
    { id: 'pot-mountain-2', type: 'pot', x: 26, y: 12, labelArabic: 'قِدر', labelEnglish: 'Dye Pot', descriptionEnglish: 'A pot of natural plant dye used by the weaver to colour wool.', vocabWordId: null, vocabCategory: null, repeatable: true },
    { id: 'lantern-mountain-1', type: 'lantern', x: 19, y: 22, labelArabic: 'فانوس', labelEnglish: 'Village Lantern', descriptionEnglish: 'A copper lantern lighting the village square as evening falls.', vocabWordId: null, vocabCategory: null, repeatable: true },
    { id: 'lantern-mountain-2', type: 'lantern', x: 21, y: 22, labelArabic: 'فانوس', labelEnglish: 'Village Lantern', descriptionEnglish: 'A second lantern flanking the path between the elder home and mosque.', vocabWordId: null, vocabCategory: null, repeatable: true },
    { id: 'fountain-mountain-1', type: 'fountain', x: 29, y: 10, labelArabic: 'نافورة', labelEnglish: 'Stream Fountain', descriptionEnglish: 'A natural spring channelled into a stone basin beside the mountain stream.', culturalNote: 'Mountain springs are considered blessed in Arab tradition, often named after saints or prophets.', vocabWordId: null, vocabCategory: null, repeatable: true },
    { id: 'barrel-mountain-1', type: 'barrel', x: 13, y: 21, labelArabic: 'برميل', labelEnglish: 'Wool Barrel', descriptionEnglish: 'A barrel of raw mountain wool waiting to be spun by the weaver.', vocabWordId: null, vocabCategory: 'clothing', loot: { type: 'dirhams', min: 6, max: 14 }, repeatable: false, stateChange: 'inspected' },
    { id: 'crate-mountain-1', type: 'crate', x: 27, y: 21, labelArabic: 'صندوق', labelEnglish: 'Medicine Crate', descriptionEnglish: 'A crate of herbal remedies prepared by the village healer for trade.', vocabWordId: null, vocabCategory: 'adjectives', loot: { type: 'dirhams', min: 8, max: 20 }, repeatable: false, stateChange: 'inspected' },
  ],
...
const coastal_port = {
  ...
  interactables: [
    ...
    // --- Phase 23: Interactive Objects ---
    { id: 'lantern-port-1', type: 'lantern', x: 33, y: 10, labelArabic: 'فانوس', labelEnglish: 'Dock Lantern', descriptionEnglish: 'A weathered iron lantern guiding ships into the harbour at night.', descriptionArabic: 'فانوس حديدي يرشد السفن ليلاً.', culturalNote: 'Arab seafarers were master navigators who sailed as far as China and East Africa.', vocabWordId: null, vocabCategory: 'directions', repeatable: true },
    { id: 'lantern-port-2', type: 'lantern', x: 33, y: 22, labelArabic: 'فانوس', labelEnglish: 'Dock Lantern', descriptionEnglish: 'A southern dock lantern, its flame reflected in the dark harbour water.', vocabWordId: null, vocabCategory: null, repeatable: true },
    { id: 'lantern-port-3', type: 'lantern', x: 15, y: 16, labelArabic: 'فانوس', labelEnglish: 'Town Lantern', descriptionEnglish: 'A brass lantern illuminating the main road through port town.', vocabWordId: null, vocabCategory: null, repeatable: true },
    { id: 'crate-port-1', type: 'crate', x: 33, y: 12, labelArabic: 'صندوق', labelEnglish: 'Shipping Crate', descriptionEnglish: 'A large crate of exotic goods arriving from overseas: silk, porcelain, and spices.', culturalNote: 'Arab dhow ships carried goods between India, Africa, and the Gulf for centuries.', vocabWordId: null, vocabCategory: 'trade', loot: { type: 'dirhams', min: 12, max: 30 }, repeatable: false, stateChange: 'inspected' },
    { id: 'crate-port-2', type: 'crate', x: 33, y: 18, labelArabic: 'صندوق', labelEnglish: 'Export Crate', descriptionEnglish: 'A crate of Arabian dates and frankincense bound for distant ports.', vocabWordId: null, vocabCategory: 'trade', repeatable: true },
    { id: 'crate-port-3', type: 'crate', x: 20, y: 12, labelArabic: 'صندوق', labelEnglish: 'Supply Crate', descriptionEnglish: 'A crate of ship supplies: rope, canvas, and tar.', vocabWordId: null, vocabCategory: null, repeatable: true },
    { id: 'barrel-port-1', type: 'barrel', x: 33, y: 24, labelArabic: 'برميل', labelEnglish: 'Fish Barrel', descriptionEnglish: 'A barrel of freshly salted fish from the morning catch.', culturalNote: 'Fishing has been a livelihood along the Arabian coast for over 7000 years.', vocabWordId: null, vocabCategory: 'food', loot: { type: 'dirhams', min: 5, max: 12 }, repeatable: false, stateChange: 'inspected' },
    { id: 'barrel-port-2', type: 'barrel', x: 12, y: 17, labelArabic: 'برميل', labelEnglish: 'Rum Barrel', descriptionEnglish: 'A barrel of date wine stored near the tavern. It smells sweet and strong.', vocabWordId: null, vocabCategory: 'food', repeatable: true },
    { id: 'barrel-port-3', type: 'barrel', x: 27, y: 17, labelArabic: 'برميل', labelEnglish: 'Tar Barrel', descriptionEnglish: 'A barrel of ship tar used to waterproof the hulls of trading dhows.', vocabWordId: null, vocabCategory: null, repeatable: true },
    { id: 'painting-port-1', type: 'painting', x: 16, y: 21, labelArabic: 'لوحة', labelEnglish: 'Sea Painting', descriptionEnglish: 'A vibrant painting of a dhow sailing at sunset, its lateen sail billowing in the wind.', culturalNote: 'The lateen sail, perfected by Arab sailors, revolutionised navigation across the Indian Ocean.', vocabWordId: null, vocabCategory: 'directions', repeatable: true },
    { id: 'painting-port-2', type: 'painting', x: 23, y: 21, labelArabic: 'لوحة', labelEnglish: 'Port Map', descriptionEnglish: 'A detailed painted map showing trade routes connecting this port to distant lands.', vocabWordId: null, vocabCategory: 'directions', repeatable: true },
    { id: 'fountain-port-1', type: 'fountain', x: 18, y: 14, labelArabic: 'نافورة', labelEnglish: 'Town Fountain', descriptionEnglish: 'A large stone fountain in the port town centre where sailors refill their water skins.', vocabWordId: null, vocabCategory: null, repeatable: true },
    { id: 'statue-port-1', type: 'statue', x: 22, y: 14, labelArabic: 'تمثال', labelEnglish: 'Navigator Statue', descriptionEnglish: 'A bronze statue of a famous navigator holding a compass and map scroll.', culturalNote: 'Ibn Majid, the "Lion of the Sea", wrote over 40 navigational texts in the 15th century.', vocabWordId: null, vocabCategory: 'directions', repeatable: true },
  ],
...
const royal_palace = {
  ...
  interactables: [
    ...
    // --- Phase 23: Interactive Objects ---
    { id: 'fountain-palace-1', type: 'fountain', x: 25, y: 20, labelArabic: 'نافورة', labelEnglish: 'Royal Fountain', descriptionEnglish: 'A magnificent central fountain surrounded by marble, its waters sparkling in the sunlight.', descriptionArabic: 'نافورة ملكية رائعة محاطة بالرخام.', culturalNote: 'Palace fountains in Islamic architecture represent paradise (jannah), with gardens built around four water channels.', vocabWordId: null, vocabCategory: 'phrases', repeatable: true },
    { id: 'fountain-palace-2', type: 'fountain', x: 8, y: 18, labelArabic: 'نافورة', labelEnglish: 'Garden Fountain', descriptionEnglish: 'A small fountain in the west garden, its gentle sound soothing visiting dignitaries.', vocabWordId: null, vocabCategory: null, repeatable: true },
    { id: 'painting-palace-1', type: 'painting', x: 18, y: 11, labelArabic: 'لوحة', labelEnglish: 'Royal Portrait', descriptionEnglish: 'A grand portrait of the palace founder, adorned in gold and lapis lazuli.', culturalNote: 'Lapis lazuli was imported from Afghanistan and prized across the Islamic world for its vivid blue colour.', vocabWordId: null, vocabCategory: 'colors', repeatable: true },
    { id: 'painting-palace-2', type: 'painting', x: 32, y: 11, labelArabic: 'لوحة', labelEnglish: 'Battle Painting', descriptionEnglish: 'A sweeping painting of a great battle with horses, banners, and desert dunes.', vocabWordId: null, vocabCategory: 'adjectives', repeatable: true },
    { id: 'painting-palace-3', type: 'painting', x: 25, y: 23, labelArabic: 'لوحة', labelEnglish: 'Garden Mosaic', descriptionEnglish: 'An intricate mosaic panel depicting flowers, birds, and flowing water in the garden.', culturalNote: 'Islamic geometric art avoids depicting living beings, instead celebrating nature through patterns and arabesques.', vocabWordId: null, vocabCategory: 'colors', repeatable: true },
    { id: 'painting-palace-4', type: 'painting', x: 40, y: 18, labelArabic: 'لوحة', labelEnglish: 'Calligraphy Panel', descriptionEnglish: 'A stunning calligraphy panel with gold leaf, displaying a poem about wisdom and justice.', vocabWordId: null, vocabCategory: 'phrases', repeatable: true },
    { id: 'lantern-palace-1', type: 'lantern', x: 16, y: 28, labelArabic: 'فانوس', labelEnglish: 'Ornate Lantern', descriptionEnglish: 'A jewel-encrusted lantern of hammered brass casting intricate shadow patterns on the courtyard walls.', culturalNote: 'Mashrabiya lanterns create geometric light patterns, a signature of Islamic decorative arts.', vocabWordId: null, vocabCategory: null, repeatable: true },
    { id: 'lantern-palace-2', type: 'lantern', x: 34, y: 28, labelArabic: 'فانوس', labelEnglish: 'Ornate Lantern', descriptionEnglish: 'A matching ornate lantern on the eastern side of the grand gate.', vocabWordId: null, vocabCategory: null, repeatable: true },
    { id: 'lantern-palace-3', type: 'lantern', x: 25, y: 33, labelArabic: 'فانوس', labelEnglish: 'Entrance Lantern', descriptionEnglish: 'A tall golden lantern illuminating the grand entrance path to the palace.', vocabWordId: null, vocabCategory: null, repeatable: true },
    { id: 'statue-palace-1', type: 'statue', x: 20, y: 28, labelArabic: 'تمثال', labelEnglish: 'Lion Statue', descriptionEnglish: 'A majestic stone lion guarding the west side of the grand gate.', culturalNote: 'Lions symbolise power and sovereignty in Islamic art, often guarding palace entrances.', vocabWordId: null, vocabCategory: 'adjectives', repeatable: true },
    { id: 'statue-palace-2', type: 'statue', x: 30, y: 28, labelArabic: 'تمثال', labelEnglish: 'Lion Statue', descriptionEnglish: 'A matching lion statue guarding the east side of the grand gate.', vocabWordId: null, vocabCategory: 'adjectives', repeatable: true },
    { id: 'crate-palace-1', type: 'crate', x: 6, y: 15, labelArabic: 'صندوق', labelEnglish: 'Treasure Crate', descriptionEnglish: 'A gilded crate containing tribute gifts from distant provinces: gold, jewels, and silk.', vocabWordId: null, vocabCategory: 'colors', loot: { type: 'dirhams', min: 20, max: 50 }, repeatable: false, stateChange: 'inspected' },
    { id: 'crate-palace-2', type: 'crate', x: 44, y: 15, labelArabic: 'صندوق', labelEnglish: 'Treasure Crate', descriptionEnglish: 'Another tribute crate, this one filled with rare manuscripts and astronomical instruments.', vocabWordId: null, vocabCategory: 'phrases', loot: { type: 'dirhams', min: 25, max: 60 }, repeatable: false, stateChange: 'inspected' },
    { id: 'pot-palace-1', type: 'pot', x: 21, y: 17, labelArabic: 'قِدر', labelEnglish: 'Rose Water Pot', descriptionEnglish: 'A pot of rose water used to perfume the palace gardens and receiving halls.', culturalNote: 'Rose water (ma ward) has been distilled in the Arab world since the 8th century.', vocabWordId: null, vocabCategory: null, repeatable: true },
    { id: 'pot-palace-2', type: 'pot', x: 29, y: 17, labelArabic: 'قِدر', labelEnglish: 'Incense Pot', descriptionEnglish: 'A pot burning oud incense, filling the garden with a rich, woody fragrance.', culturalNote: 'Oud (agarwood) is called "liquid gold" in the Arab world and has been prized for over 3000 years.', vocabWordId: null, vocabCategory: null, repeatable: true },
  ],
