...
must_haves:
  truths:
    ...
    - "CompanionManager spawns/despawns active exploration companion and updates only 2 companions per frame"
...
4. CompanionDialogueManager returns context-filtered, CEFR-scaled dialogue
5. CompanionContext emits COMPANION_CONTEXTUAL_COMMENT with 10-second cooldown
6. DialogueEngine handles recruit_companion effect (dispatches to companionSlice)
7. narrativeSlice clamps companion relationships to 0-100 and NPCs to 0-5
8. No modifications to NPC.js (Companion extends, not modifies)
</verification>
